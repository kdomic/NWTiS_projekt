        ...
        <div id="wrapper">
            ...
            <div id="main">
                ...
                <article id="email" class="panel">
                    <ul>
                        <li><a href="./dodajAdresu.jsp">Dodaj adresu</a></li>
                        <li><a href="./PregledAdresa">PregledAdresa</a></li>
                        <li><a href="./MeteoPodaci">MeteoPodaci</a></li>
                        <li><a href="./PregledDnevnika">PregledDnevnika</a></li>
                    </ul>
                </article>
            </div>
